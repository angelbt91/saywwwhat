...
export default async function handler(
  ...
  Make sure the website has at least 4 sections with relevant content. If no content is provided in the paragraph below, please make up the content yourself based on the topic of the website, but avoid using Lorem Ipsum (filler text).
